...
/*
	20180618, making some changes
	  ...
	  - add default values to main.h to set trial parameters (makes it easier to modify)
*/
...
//input
const int startTrialPin = 3; //start trial when this pin goes hi
...
//motor pins (assuming easydriver)
